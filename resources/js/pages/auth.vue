<template>
    <div class="flex flex-col md:flex-row h-screen items-center">
        <div class="bg-indigo-600 hidden md:block w-full md:w-1/4 lg:3/4 xl:w-3/4 h-screen">
            <img v-bind:src="backgroundImg" alt="" class="w-full h-full object-cover">
        </div>
        <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-3/4 lg:1/4 xl:w-1/4 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
            <div class="w-full h-100">
                ...
                <form class="" action="#" method="POST" @submit.prevent="handleOauth">
...
<script>
    import {handleLogin, handleOauthRedirect} from '../api/index';
    const backgroundImg = '/images/background/mix.jpg';
    export default {
        name: 'Auth',
        data() {
            return {
                ...
                backgroundImg,
                formData: {
                    email: 'lera51@example.org',//'moaj257@gmail.com',
            ...
            async handleLogin() {
                ...
                this.formData.loading = true;
                this.formData.error = '';
                await handleOauthRedirect('google')
                    .then(({data}) => {
